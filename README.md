...
The one named using hyphens has not outputs but can be visualized in GitHub. 
The one named using underscores has outputs but cannot be visualized in GitHub, we recommend downloading and open it using Google Colab.
